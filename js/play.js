...
if (window.top != window) {
	...
	// 修改title
	document.title = gameInfo.n + ' - ' + 'NDS游戏盒';
	...
	// ROM
	romUrl = (gameInfo.s == "c" ? "https://storage.heheda.top/nds-rom/" : "../roms/") +
		gameInfo.i + ".7z";
...
const share = () => {
	navigator.share({
		...
		url: urldata,
		text: '推荐使用电脑，运行更加流畅！在线免费畅玩或下载NDS经典游戏，让我们一同找回童年的快乐！玩NDS游戏，就认准NDS游戏盒！'
	});
}
// 下载rom按钮
const dowrom = () => {
